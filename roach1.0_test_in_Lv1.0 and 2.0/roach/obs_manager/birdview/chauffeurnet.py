...
class ObsManager():
    def __init__(self, obs_configs, criteria_stop=None):
        ...
        print(f"self._pixels_per_meter:{self._pixels_per_meter}")
    ...
    def attach_ego_vehicle(self, ego_vehicle):
        ...
        maps_h5_path = "/home/vci-1/XT/DriveAdapter/roach/obs_manager/birdview/maps/Town12/Town12.h5" #"#self._map_dir / (self._world.get_map().name + '.h5')
        with h5py.File(maps_h5_path, 'r', libver='latest', swmr=True) as hf:
            ...
            print(f"float(hf.attrs['pixels_per_meter']:{float(hf.attrs['pixels_per_meter'])}")
    ...
    def get_observation(self, route_plan):
        ...
        vehicle_bbox_list = self._world.get_level_bbs(carla.CityObjectLabel.Car) #Vehicles
