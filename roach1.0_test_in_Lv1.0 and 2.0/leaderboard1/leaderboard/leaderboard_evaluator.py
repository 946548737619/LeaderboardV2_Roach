...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
           ...
           # print(f"agent_class_name:{agent_class_name}\self.module_agent:{self.module_agent}")
            ...
            self.agent_instance.folder_name = "/home/vci-1/XT/DriveAdapter/roach_folder"
...
def main():
    ...
    parser.add_argument("--agent", type=str, help="Path to Agent's py file to evaluate", required=True) #"-a",
    ...
    parser.add_argument('--is_local', type=str2bool, default=True, help='whether in local machine')
